...
Para el desarrollo de este proyecto, se realizan iteraciones donde en cada una se sigue un ciclo que incluye los requerimientos que se abordan, el desarrollo, las pruebas y los resultados obtenidos. Un enfoque iterativo permite ajustar y mejorar continuamente el proyecto, asegurando que se cumplan todos los requerimientos y objetivos. A continuación, se detallan cada una de las etapas de una iteración típica.
...
\input{iteraciones_desarrollo/iteración_0/iteración_0}

\input{iteraciones_desarrollo/iteracion_1/iteracion_1}

\input{iteraciones_desarrollo/iteracion_2/iteracion_2}

\input{iteraciones_desarrollo/iteracion_3/iteracion_3}

\input{iteraciones_desarrollo/iteracion_4/iteracion_4}

\input{iteraciones_desarrollo/iteracion_5/iteracion_5}

\input{iteraciones_desarrollo/iteracion_6/iteracion_6}