...
\begin{itemize}
    ...
    \item Iteración 6: Mediciones con códigos QR
        \begin{itemize}
        \item Captura y envío de fotografías por Wi-Fi
...
\begin{figure}[H]
    ...
    \caption{Monitoreo del robot en tiempo real en la interfaz de usuario}
...
\section{Resultados y métricas finales}

A continuación se detallan algunas métricas de relevancia obtenidas a lo largo del proyecto.
...
\begin{tabular}{|l|l|l|}
	\hline \rowcolor{test_header_color}
        ...
        \hline
            Tamaño de celda del mapa        & $0.5$         & $m$ \\
        \hline
            Distancia entre imanes          & $0.15$        & $m$ \\
        \hline
            Dimensiones totales de la pista & $1.4\ x\ 1.4$ & $m\ x\ m$ \\
        \hline
\end{tabular}
\caption{Parámetros del mapa y la pista}
\end{table}
...
\begin{tabular}{|l|l|l|}
	\hline \rowcolor{test_header_color}
        Descripción & Valor & Unidad de medida \\
        \hline
            Velocidad de desplazamiento lineal      & $0.25$    & $m/seg$ \\
        \hline
            Velocidad de desplazamiento rotacional  & $0.18$    & $m/seg$ \\
        \hline
            Consumo de energía promedio en desplazamiento lineal  & $13.8$    & $W\ @ 12V$ \\
        \hline
            Consumo de energía promedio en desplazamiento rotacional  & $12.7$    & $W\ @ 12V$ \\
        \hline
\end{tabular}
\caption{Métricas de desplazamiento}
\end{table}
...
\begin{tabular}{|l|l|l|}
	\hline \rowcolor{test_header_color}
        ...
        \hline
            Tamaño máximo de fotografía & $120$ & $KBytes$ \\
        \hline
            Frecuencia de captura de imágenes & $2$ & $FPS$ \\
        \hline
            Tamaño máximo de paquete MQTT & $256$ & $KBytes$ \\
        \hline
            Latencia promedio con el broker en la red local & $100$ & $ms$ \\
        \hline
    \end{tabular}
\caption{Mediciones capturadas en el envío de imágenes}
\end{table}
...
\begin{tabular}{|l|l|l|}
	\hline \rowcolor{test_header_color}
        Descripción & Valor & Unidad de medida \\
        \hline
            Tiempo promedio de recepción de muestras/mediciones & $560$ & $ms$ \\
        \hline
            Tiempo máximo de recepción de muestras/mediciones: & $1090$ & $ms$ \\
        \hline
    \end{tabular}
    \caption{Tiempos registrados en la recepción de muestras}
\end{table}
