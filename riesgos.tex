...
En la siguiente tabla se exponen los criterios en base a los cuales se cuantifica la probabilidad de ocurrencia de los riesgos anteriormente mencionados.
\begin{table}[H]
\centering
\begin{tabular}{
...
En la siguiente tabla se expresan los criterios en base a los cuales se cuantificó el impacto de los riesgos.
\begin{table}[H]
\centering
\begin{tabular} {
	| >{\centering\arraybackslash}m{3cm}
...
En la tabla debajo se expone el impacto estimado en cuanto al máximo tiempo que puede provocar la efectivización de un riesgo en el peor de los casos.
\begin{table}[H]
\centering
\begin{tabular}{|c|c|c|}
	\hline \rowcolor{test_header_color}
