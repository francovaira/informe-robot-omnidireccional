...
Al realizar las sucesivas pruebas, en ocasiones notamos que el robot sobrepasaba el punto de llegada. Para mejorar este aspecto, sumamos una implementación al robot que consiste en reducir la velocidad de las ruedas, y por lo tanto su velocidad de desplazamiento, cuando este se encuentre a cierta distancia de su coordenada destino. De este modo logramos una mayor precisión del robot al posicionarse en el punto de llegada.
