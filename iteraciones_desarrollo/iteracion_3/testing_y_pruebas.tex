...
\begin{testtableformat}
    ...
    \hline
        Resultado obtenido  & La secuencia de coordenadas calculadas se corresponde a la más óptima para cada par de puntos y se cumple la restricción de movimiento \\
    \hline
        Observaciones       & - \\
    \hline
\end{testtableformat}
