...
Se opta por motores de corriente continua, como el que se muestra en la figura siguiente, pues el torque generado es proporcional a la diferencia de potencial aplicada a los terminales de alimentación y el sentido de giro depende de la polaridad, facilitando de este modo el control. El modelo de motor elegido se muestra en la imagen debajo, es un motorreductor de $12V\ @\ 100\ RPM$.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\linewidth]{images/motorreductor.png}
    \caption{Motorreductor utilizado en el proyecto}
\end{figure}
...
Se realizaron distintas corridas variando la tensión y corriente, se tomaron mediciones de velocidad y torque. Con estos datos se construyeron las curvas de RPM-torque y corriente-torque, como se muestra en la siguiente tabla:
...
Para el control de estos integrados, vamos a usar cuatro canales PWM del microcontrolador ESP32, los cuales van a establecer el sentido de giro y fuerza del motor.