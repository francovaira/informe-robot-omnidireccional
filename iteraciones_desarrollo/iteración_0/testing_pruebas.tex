...
\begin{testtableformat}
   ...
   \hline
       Descripción         & Crear, compilar y grabar un programa simple que logre establecer una conexión inalámbrica usando el protocolo WiFi \\
   \hline
       Precondición        & PRECOND\_A \\
   \hline
       Pasos del test      & \begin{enumerate}
                               ...
                               \item Compilar el proyecto
                               \item Grabar el programa en el microcontrolador
                               \item Establecer una conexión inalámbrica WiFi
                           \end{enumerate} \\
   \hline
