...
En el presente proyecto se detalla el proceso de diseño y puesta en marcha de un sistema ciber físico el cual usa cómo base la estructura del robot móvil omnidireccional Hermes III, desarrollado como proyecto integrador de la carrera de grado Ingeniería en Computación en la Facultad de Ciencias Exactas, Físicas y Naturales.
